...
- Si crear_venta o actualizar_producto retornan alternativas ("Quisiste decir..."), informáselas al usuario y pide que confirme cuál es el producto. Luego llama a la herramienta de nuevo con el nombre exacto sugerido.
